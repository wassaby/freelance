 ...
 * $Id: VioServlet.java,v 1.4 2014/07/18 11:49:25 dauren_work Exp $
 */
 ...
 * @author dimad
 */
public class SatoriServlet extends ActionServlet {
	...
	public void init() throws ServletException {
		try {
			...
			log = Logger.getLogger(SatoriServlet.class);
			...
			getServletContext().setAttribute(SatoriConstants.MANAGER_ATTR,
					manager);
