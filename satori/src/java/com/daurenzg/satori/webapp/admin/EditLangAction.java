...
public class EditLangAction extends AbstractAdminAction {

	@Override
	protected ActionForward executeAdminAction(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		EditLangForm langForm = (EditLangForm) form;
		try {
			...
			dict.editLang(langForm.getId(), langForm.getName(), langForm.getCode());
