...
public class ChangePswdForwardAction extends AbstractAdminAction {
	...
	protected ActionForward executeAdminAction(ActionMapping mapping,
		...
		try {
			...
			BDictInfo loginInfo = dict.getUsers(SatoriConstants.USER_TYPE_MANAGER);
			session.setAttribute(SatoriConstants.USER_MANAGER_PSWD_CHANGE, loginInfo);
