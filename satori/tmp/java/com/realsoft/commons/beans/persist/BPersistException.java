...
public class BPersistException extends CommonsBeansException implements
	...
	public BPersistException() {
	}

	public BPersistException(String errorCode, String messageKey,
			String messageText) {
