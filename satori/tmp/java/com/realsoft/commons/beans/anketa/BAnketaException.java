...
public class BAnketaException extends CommonsBeansException implements
	...
	public BAnketaException() {
	}

	public BAnketaException(String errorCode, String messageKey,
			String messageText) {
