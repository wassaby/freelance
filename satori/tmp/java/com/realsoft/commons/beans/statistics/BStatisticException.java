...
public class BStatisticException extends CommonsBeansException implements
	...
	public BStatisticException() {
	}

	public BStatisticException(String errorCode, String messageKey,
			String messageText) {
