...
public class BURLResolverException extends CommonsBeansException implements
	...
	public BURLResolverException() {
	}

	public BURLResolverException(String errorCode, String messageKey,
			String messageText) {
