...
public class BMonthByDayException extends CommonsBeansException implements
	...
	public BMonthByDayException() {
	}

	public BMonthByDayException(String errorCode, String messageKey,
			String messageText) {
