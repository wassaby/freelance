...
public class BAccountException extends CommonsBeansException implements
	...
	public BAccountException() {
	}

	public BAccountException(String errorCode, String messageKey,
			String messageText) {
