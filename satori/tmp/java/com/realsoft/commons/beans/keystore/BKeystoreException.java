...
public class BKeystoreException extends CommonsBeansException implements
	...
	public BKeystoreException() {
	}

	public BKeystoreException(String errorCode, String messageKey,
			String messageText) {
