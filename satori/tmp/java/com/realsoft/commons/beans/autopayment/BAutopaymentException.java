 ...
 * IBAutopayment. Этот класс расширяет класс исключений CommonsBeansException.
 * 
 * @author temirbulatov
 * 
 */
public class BAutopaymentException extends CommonsBeansException implements
	...
	public BAutopaymentException() {
	}

	/**
	 * Конструктор класса BAutopaymentException
	 * 
	 * @param errorCode
	 ...
	 *            текст сообщения
	 */
	public BAutopaymentException(String errorCode, String messageKey,
			String messageText) {
