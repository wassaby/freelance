...
public class EditInstanceAction extends AbstractAdminAction {
	...
	protected ActionForward executeAdminAction(ActionMapping mapping,
		...
		EditInstanceForm fForm = (EditInstanceForm) form;
		...
		try {
        	...
        	report.editInstance(fForm.getInstanceId(), fForm.getName());
        	error.put("error", 0);
        	error.put("msg", "OK");
