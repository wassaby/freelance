...
public class BConnectorException extends CommonsBeansException implements
	...
	public BConnectorException() {
	}

	public BConnectorException(String errorCode, String messageKey,
			String messageText) {
