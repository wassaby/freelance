...
public class BQueueOutException extends CommonsBeansException implements
	...
	public BQueueOutException() {
	}

	public BQueueOutException(String errorCode, String messageKey,
			String messageText) {
