...
public class BRequestException extends CommonsBeansException implements
	...
	public BRequestException() {
	}

	public BRequestException(String errorCode, String messageKey,
			String messageText) {
