...
public class BDealerException extends CommonsBeansException implements
	...
	public BDealerException() {
	}

	public BDealerException(String errorCode, String messageKey,
			String messageText) {
