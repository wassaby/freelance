...
public class BCreditLimitException extends CommonsBeansException implements
	...
	public BCreditLimitException() {
	}

	public BCreditLimitException(String errorCode, String messageKey,
			String messageText) {
