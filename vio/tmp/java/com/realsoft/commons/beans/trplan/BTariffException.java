...
public class BTariffException extends CommonsBeansException implements
	...
	public BTariffException() {
	}

	public BTariffException(String errorCode, String messageKey,
			String messageText) {
